                ...
                for S2_S3 in first_second_quantile:
                    ...
                    if S2_S3 == flag_issue_quantile:
                        ...
                        for inst in dict_check_flags:
                            st.write(table[table[con_checks_id_col] == inst]['Class trend'].unique()[0])
                            dict_trend[list(dict_trend.keys())[table[table[con_checks_id_col] == inst]['Class trend'].unique()[0]]] += 1
