...
multi_time = st.sidebar.selectbox("multivariable time col", table.columns, 0)
...
multiSlider = st.sidebar.slider("multivarible time value", table[multi_time].min(), table[multi_time].max(), table[multi_time].min())
